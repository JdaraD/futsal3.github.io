      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a class="small mr-3"><span class="icon-phone2 mr-2"></span> 081345678910</a> 
            <a class="small mr-3"><span class="icon-envelope-o mr-2"></span> gilanggila@gmail.com</a> 
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="<?= base_url('welcome') ?>" class="d-block">
              <img src="<?= base_url() ?>assets/images/bsi3.png" alt="Image" class="d-block w-100" >
            </a>
          </div>
          <div class="mr-auto">
